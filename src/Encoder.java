...
public class Encoder {
    ...
    public static ArrayList<Long> list = new ArrayList<>(10000000);
    //public static ArrayList<Long> revList = new ArrayList<>(10000000);
    public static Map<Long, Integer> revMap = new HashMap<>(10000000);

    private static String codeBookPath = "./TOTALBITS.txt";
    private static String uploadedImagesFromClient = "./";
        ...
        synchronized (list) {
            ...
            try (InputStream in = Files.newInputStream(inputFile);
                ...
                while ((line = reader.readLine()) != null) {
                    ...
                    list.add(Long.parseLong(line,2));
                    revMap.put(Long.parseLong(line,2),cnt);
                    //revList.add(cnt);

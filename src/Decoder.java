...
public class Decoder {
    ...
    public static byte[] image2Byte(String path){
        ...
        while (index2 != -1 && cnt < 3600) {
            ...
            try{
                ...
                long ind = Long.parseLong(binaries,2);

                index2 = Encoder.revMap.get(ind);
                //index2 = Encoder.list.get(indd);
    ...
    public static  String dec2Bit(String line){
        ...
        for(String dct:dcts) {
            int number = Integer.parseUnsignedInt(dct);
